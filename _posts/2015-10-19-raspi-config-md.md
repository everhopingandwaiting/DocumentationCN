...
![raspi-config main screen]( https://github.com/RaspberryPiChina/documentation/blob/master/configuration/images/raspi-config.png)
...
如果Raspbian是使用NOOBS安装的，这个选项可以跳过，因NOOBS会自动扩展文件系统。但是如果用户自行使用系统镜像安装系统，则需要应用该选项
